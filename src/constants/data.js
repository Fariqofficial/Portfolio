export const PORTFOLIO_DATA = {
    ...
    technologies: [
        { 
            name: 'Flutter', 
            icon: require('../assets/icons/ic_flutter.png') 
        },
        { 
            name: 'Dart', 
            icon: require('../assets/icons/ic_dart.png')
        },
        { 
            name: 'Firebase', 
            icon: require('../assets/icons/ic_firebase.png') 
        },
        { 
            name: 'Java', 
            icon: require('../assets/icons/ic_java.png') 
        },
        { 
            name: 'Laravel', 
            icon: require('../assets/icons/ic_laravel.png') 
        },
        { 
            name: 'React Native', 
            icon: require('../assets/icons/ic_react_native.png')
        },
        { 
            name: 'Node JS', 
            icon: require('../assets/icons/ic_node.png')
         },
        {
            name: 'JavaScript', 
            icon: require('../assets/icons/ic_javascript.png')
        },
        {
            name: 'Android Studio', 
            icon: require('../assets/icons/ic_android_studio.png')
        },
        {
            name: 'Visual Studio Code', 
            icon: require('../assets/icons/ic_vs_code.png')
        },
        {
            name: 'Git', 
            icon: require('../assets/icons/ic_git.png')
        },
        {
            name: 'Figma', 
            icon: require('../assets/icons/ic_figma.png')
        },
        {
            name: 'MySQL', 
            icon: require('../assets/icons/ic_sql.png')
        },
        {
            name: 'Postman', 
            icon: require('../assets/icons/ic_postman.png')
        },
    ],
    projects: [
        {
